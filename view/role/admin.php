                    ...
                    <form action="../../controller/con_logout.php" method="POST">
                        <div>
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary btn-sm small-font" type="button">ดูคอร์สทั้งหมด</button>
                                </div>
                                <br>
                                <a class="text-body x-small-font" id="right" href="../../controller/con_logout.php">logout</a>
                            </div>
                    </form>
                    <br>
                    <br>
